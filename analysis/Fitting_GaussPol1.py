...
#   単一ピークを「ガウス + 1次関数（傾き + 切片）」でフィットします。
#
# 【使い方】
...
TitleY = 'Y Title'
# -------- 初期設定（状況に応じて変更） --------
p_init    = [1000, mu, sigma, 10, 0.0]
p_bounds  = ([0, mu - 2.0 * sigma, 1, 0, -10], [1_000_000, mu + 2.0 * sigma, 50, 10_000, 10])
...
# -------- フィット結果の出力 --------
names = ["p0 (area)", "p1 (mu)", "p2 (sigma)", "p3 (intercept)", "p4 (slope)"]
